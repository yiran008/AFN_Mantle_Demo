...
@property (nonatomic) BOOL colorSwicth;
...
//		text = [text stringByAppendingFormat:@"\nSwipe down with %i finger%@ to hide console", touches, (touches != 1)? @"s": @""];
        text = [text stringByAppendingFormat:@"\n说明：摇晃或上下滑动%i根手指控制平台界面的显示/隐藏", touches];
	}
...
- (void)keyboardWillHide:(NSNotification *)notification
{
    ...
    {
        self.colorSetView.top =  [self onscreenFrame].size.height - (EDITFIELD_HEIGHT + 10 + TOOL_BUTTON_HEIGHT);
    }
	[UIView commitAnimations];
}
...
- (void)showCommonAction:(id)sender
{
        ...
        self.commonInfoScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, self.view.bounds.size.height, 320, 300)];
        self.commonInfoScrollView.contentSize =  CGSizeMake(320, 1*5);
...
//        closeButton.backgroundColor = [UIColor colorWithHex:0x999999];
        ...
        for (int n = 1; n<=30; n++)
        {
            NSString *testStrDev = [NSString stringWithFormat:@"test%d&dev",n];
            [self.commonInfoArray addObject:testStrDev];
        }
        for (int n = 1; n<=30; n++)
        {
            NSString *testStr = [NSString stringWithFormat:@"%d.test",n];
            [self.commonInfoArray addObject:testStr];
        }
    
        for (int i=0; i<self.commonInfoArray.count; i++)
        {
        ...
        int k = self.commonInfoArray.count % 3 ? 1 : 0;
        self.commonInfoScrollView.contentSize =  CGSizeMake(320, 32+(self.commonInfoArray.count/3+k)*26);
...
//    [self.inputField resignFirstResponder];
    ...
    self.colorSetView = [[UIView alloc]initWithFrame:CGRectMake(-320, self.view.bounds.size.height-(EDITFIELD_HEIGHT + 10 + TOOL_BUTTON_HEIGHT), 320, EDITFIELD_HEIGHT + 10 + TOOL_BUTTON_HEIGHT)];
    self.colorSetView.backgroundColor =  [UIColor colorWithHex:0x999999];
    ...
    textButton.backgroundColor = [UIColor colorWithHex:0x333333];
    ...
    bgButton.backgroundColor = [UIColor colorWithHex:0x555555];
...
- (void)colorSwicthAction:(UIButton *)sender
{
    ...
    if ([sender.titleLabel.text isEqualToString:@"文字颜色-关闭"])
    {
        ...
        sender.backgroundColor = [UIColor colorWithHex:0x333333];
        tmpBt = (UIButton *)[self.colorSetView viewWithTag:2001];
        [tmpBt setTitle:@"背景颜色-关闭" forState:UIControlStateNormal];
        tmpBt.backgroundColor = [UIColor colorWithHex:0x555555];
        self.colorSwicth = NO;
        [self checkAndChangeColorsList:_consoleView.backgroundColor andCurrentColor:_consoleView.textColor];
    }
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    topToolView.top = self.commonInfoScrollView.contentOffset.y;
}
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
	if ((self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil]))
	{
        ...
        self.infoString = @"Babytree APP测试控制平台：";
...
- (void)viewDidLoad
{
    ...
    self.backgroundColor = [UIColor colorWithHex:0x999999 alpha:1];
    ...
    for (int i=0; i<shortcutNames.count; i++)
    {
        ...
        shortcutButtons.backgroundColor = [UIColor colorWithHex:0x666666];
    ...
    [self.showCommonButton setTitle:@"常用环境组合" forState:UIControlStateNormal];
    ...
    self.showCommonButton.backgroundColor = [UIColor colorWithHex:0x666666];
    self.showCommonButton.titleLabel.font = [self.showCommonButton.titleLabel.font fontWithSize:14];
	self.showCommonButton.frame = CGRectMake(self.inputField.right + 6,
                                              self.view.frame.size.height - EDITFIELD_HEIGHT - 5-TOOL_BUTTON_HEIGHT,
    ...
    self.FLEXButton.backgroundColor = [UIColor colorWithHex:0x666666];
    ...
    self.colorSetButton.backgroundColor = [UIColor colorWithHex:0x666666];
