//
//  BBPreparationEditViewController.m
//  pregnancy
//
...
@interface BBPreparationEditViewController ()
...
@implementation BBPreparationEditViewController
...
- (void)addUserTable
{
    if ([[[UIDevice currentDevice] systemVersion] floatValue] < 7.0) {
        self.userTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 10, DEVICE_WIDTH, DEVICE_HEIGHT - 20 - 44 - 10) style:UITableViewStylePlain];
        
    }else {
        self.userTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 10, DEVICE_WIDTH, DEVICE_HEIGHT - 20 - 44 - 10) style:UITableViewStyleGrouped];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            //            [self setLocationShowWithCell:cell];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            UIActionSheet *selectSex = [[UIActionSheet alloc] initWithTitle:@"选择性别" delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"女", @"男", nil];
            [selectSex setTag:5];
...
- (void)navigationController:(UINavigationController *)navigationController willShowViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    //设置导航栏颜色
    [viewController.navigationController setPregnancyColor];
