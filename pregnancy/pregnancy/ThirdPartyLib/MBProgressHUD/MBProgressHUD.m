...
- (void)updateIndicatorsToStyle:(UIActivityIndicatorViewStyle)style
{
	BOOL isActivityIndicator = [indicator isKindOfClass:[UIActivityIndicatorView class]];
    
    if (isActivityIndicator)
    {
        UIActivityIndicatorView *ai = (UIActivityIndicatorView *)indicator;
        if (ai.activityIndicatorViewStyle != style)
        {
            [indicator removeFromSuperview];
            self.indicator = nil;
        }
        
        isActivityIndicator = NO;
    }
...
- (void)show:(BOOL)animated showBackground:(BOOL)bShow
{
    if (!bShow)
    {
        self.mode = MBProgressHUDModeIndeterminate;
        ...
        [self updateIndicatorsToStyle:UIActivityIndicatorViewStyleGray];
    }
    
    [self show:animated];
}

- (void)show:(BOOL)animated showBackground:(BOOL)bShow useGray:(BOOL)useGray
{
    if (!bShow)
    {
        self.mode = MBProgressHUDModeIndeterminate;
...
- (void)show:(BOOL)animated withText:(NSString *)text;
{
...
- (void)show:(BOOL)animated withText:(NSString *)text delay:(NSTimeInterval)delay;
{
    [self setLabelText:text];
    self.color = nil;
    self.mode = MBProgressHUDModeText;
