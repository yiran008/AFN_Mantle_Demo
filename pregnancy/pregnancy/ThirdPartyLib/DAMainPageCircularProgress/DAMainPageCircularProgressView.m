...
@implementation DAMainPageCircularProgressLayer
...
- (id)initWithLayer:(DAMainPageCircularProgressLayer *)layer
{
...
@implementation DAMainPageCircularProgressView

+ (void) initialize
{
    if (self != [DAMainPageCircularProgressView class])
        return;
...
+ (Class)layerClass
{
    return [DAMainPageCircularProgressLayer class];
}

- (DAMainPageCircularProgressLayer *)circularProgressLayer
{
    return (DAMainPageCircularProgressLayer *)self.layer;
}
...
- (void)setProgress:(CGFloat)progress animated:(BOOL)animated
{
    ...
    if (animated)
    {
        ...
        animation.duration = 0.5f;//fabsf(self.progress - pinnedProgress); // Same duration as UIProgressView animation
